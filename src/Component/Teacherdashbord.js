...
function Teacherdashbord({ children }) {
    return (
                ...
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between  cursor-pointer items-center mb-6">
                            <NavLink to="/Dashbord/Quizcreate" className="flex items-center justify-between w-full text-gray-600 hover:text-gray-500" activeStyle={{color:"white"}}>
                                <div className="flex items-center">
                                    ...
                                    <span className="text-sm  ml-2">CREATE QUIZ</span>
                                </div>
                              
                            </NavLink>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                <NavLink to="/Dashbord/videoupload"  className="flex items-center justify-between w-full text-gray-600 hover:text-gray-500" activeStyle={{color:"white"}}>
                            <div className="flex items-center">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <Link to="/Createteacher"> <span className="text-sm  ml-2">CREATE QUIZ</span></Link>
                            </div>
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2"> UPLOAD VIDEO</span>
                            </div>
