            ...
            <body className="bg-gray-300" style={{ "font-family": "Roboto" }}>
                <div className="w-full h-screen flex items-center">
                    <form className="w-full md:w-6/12 bg-white  py-20 mt-28">
                        ...
                        <h2 className="text-3xl text-center text-gray-700 mb-4">TEACHER SIGN UP</h2>
                        <div className="px-12 pb-10">
                            ...
                            <Link to="/Login"> <a href="#" className="text-xs text-gray-500 float-right mb-4">I allready have an Account</a></Link>
                            <Link to="/Login"> <button type="submit"

                                className="w-full py-2 rounded-full bg-green-600 text-gray-100  focus:outline-none">SIGN UP</button></Link>
                        </div>
                    </form>
