                ...
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between  cursor-pointer items-center mb-6">
                            <NavLink to="/Dashbord/Createteacher" className="flex items-center justify-between w-full text-gray-600 hover:text-gray-500" activeStyle={{color:"white"}}>
                                <div className="flex items-center">
                                    ...
                                    <span className="text-sm  ml-2">CREATE TEACHER</span>
                                </div>
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                <NavLink to="/Dashbord/assignsubject"  className="flex items-center justify-between w-full text-gray-600 hover:text-gray-500" activeStyle={{color:"white"}}>
                            <div className="flex items-center">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <Link to="/Createteacher"> <span className="text-sm  ml-2">CREATE TEACHER</span></Link>
                            </div>
                            <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">5</div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">ASSIGN SUBJECT</span>
                            </div>
                            <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">8</div>
                        </li>
